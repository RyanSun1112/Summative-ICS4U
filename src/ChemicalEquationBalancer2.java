...
public class ChemicalEquationBalancer2 {
     ...
     */
    public static String Balancing (ArrayList<String> reactants1, ArrayList<String> products1) {
        String pre_reactants_String= "";
        String pre_products_String = "";
        for(int i = 0; i < reactants1.size();i++){
            pre_reactants_String += reactants1.get(i);
            if(i+1 == reactants1.size()){
                break;
            }
            pre_reactants_String +="+";
        }
        for(int i = 0; i < products1.size();i++){
            pre_products_String += products1.get(i);
            if(i+1 == products1.size()){
                break;
            }
            pre_products_String +="+";
        }
        ...
        return String.valueOf(reactantString+" ---> "+productString);
    }
